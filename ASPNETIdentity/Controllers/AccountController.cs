...
namespace ASPNETIdentity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            //https://stackoverflow.com/questions/48453421/asp-net-identity-store-does-not-implement-iuseremailstoretuser
                var result = await UserManager.CreateAsync(user, model.Password); // For calling CreateAsync on UserManager, by default, I have to implement these store Interface: IUserStore,IUserPasswordStore, IUserSecurityStampStore,IUserEmailStore,IUserLockoutStore. Most of calls to these methods has been templated in UserManager.
                if (result.Succeeded)
                {
